...
function buildIndexItems(market) {
...
function buildEffectItems(effect) {
    if (!effect)
        return [];
    return [
...
Page({
    ...
    async loadPage() {
        ...
        try {
            const home = await (0, api_1.request)('/api/dashboard/home', { groupName: '我的自选' });
            this.setData({
                home,
