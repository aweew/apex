...
<template>
  <AuthShell brand-name="灵极" title="登录你的研究账户" description="进入 APEX 量化研究平台">
      <el-form ref="formRef" :model="form" :rules="rules" label-position="top" @submit.prevent="submit">
        ...
        <el-form-item prop="password" class="password-form-item">
          <template #label>
            <span class="password-label-content">
              <span>密码</span>
        ...
        <el-button type="primary" native-type="submit" :loading="loading" class="submit-btn">进入 APEX</el-button>
      </el-form>
...
.password-form-item :deep(.el-form-item__label) { display: block; position: relative; width: 100%; }
.password-form-item :deep(.el-form-item__label::before) { position: absolute; left: 0; top: 0; }
.password-label-content { display: flex; align-items: center; justify-content: space-between; padding-left: 15px; }
.forgot-password { padding: 0; border: 0; background: transparent; color: #0d58af; font: inherit; font-size: 12px; font-weight: 600; cursor: pointer; }
